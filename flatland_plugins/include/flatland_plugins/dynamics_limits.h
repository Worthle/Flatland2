...
class DynamicsLimits {
 public:
  double acceleration_limit_ = 0.0;  // Maximum rate of change in velocity in
                                     // the direction away from zero. Zero value
                                     // disables this limit.
  double deceleration_limit_ = 0.0;  // Maximum rate of change in velocity in
                                     // the direction towards zero. Zero value
                                     // disables this limit.
  double velocity_limit_ = 0.0;      // Maximum rate of change in position (in
  // either direction). Zero value disables this
  // limit.
   ...
   * @param[in]     timestep  The timestep (seconds) (used to calculate
   * acceleration from delta velocity)
   * @return        The new velocity result after target velocity has been
   * subjected to limits
   */
