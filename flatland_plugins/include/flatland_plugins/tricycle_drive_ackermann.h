...
#ifndef FLATLAND_PLUGINS_TRICYCLE_DRIVE_AACKERMANN_H
#define FLATLAND_PLUGINS_TRICYCLE_DRIVE_AACKERMANN_H
...
class TricycleDriveAckermann : public flatland_server::ModelPlugin {
 public:
  Body* body_;
  ...
  b2Vec2 last_odom_position_;
  double last_odom_angle_ = 0.0;
  ...
  */
  void TwistCallback(const ackermann_msgs::msg::AckermannDriveStamped& msg);
